...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    ...
    <div id="bg" class="z-0 bg-transparent"></div>
    <div class="container-fluid bg-transparent z-1">
      <div id="screen" class="row bg-transparent">
        ...
        <div id="" class="col-md-9 col-lg-7 bg-transparent">
            <div id="gridPanel" class="z-n1 container-fluid">
                    <div id="r1" class="row">
